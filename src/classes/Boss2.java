...
public class Boss2 extends Inimigos {
    ...
    public boolean atualizaEstado(long deltaTime, long currentTime, double playerY, LinkedList<Projetil> projetilInimigo){
		...
		if (this.ponto.getY() < GameLib.HEIGHT*0.06) this.ponto.setY(this.ponto.getY() + this.ponto.getvY() * deltaTime * (0.8)); //Adicionando limite que o Boss 2 pode descer
